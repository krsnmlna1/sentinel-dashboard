...
export function StatCard({ 
  ...
  return (
    ...
    >
      ...
      <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${styles.bg} to-transparent rounded-bl-full -mr-8 -mt-8`} />
      ...
      <div className="relative z-10">
        ...
        <p className="text-xs text-gray-400 font-mono border-t border-white/5 pt-3 mt-1 flex items-center justify-between">
          <span>{subValue}</span>
