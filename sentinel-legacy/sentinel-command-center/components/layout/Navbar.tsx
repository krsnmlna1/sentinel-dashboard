...
const Navbar: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: 'SCOUT', path: '/scout', icon: Radio },
  ...
  return (
    <motion.nav 
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-sentinel-bg/80 backdrop-blur-xl h-16"
    >
      <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4 text-xs font-mono text-sentinel-muted border-l border-white/10 pl-6">
