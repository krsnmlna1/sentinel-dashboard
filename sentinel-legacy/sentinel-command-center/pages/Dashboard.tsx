    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-sentinel-muted text-sm max-w-xl">
        ...
        <div className="flex gap-3">
           ...
           <div className="px-3 py-1 rounded bg-sentinel-card border border-white/10 text-sentinel-muted text-xs font-mono">
             v2.4.0-BETA
           </div>
        </div>
      </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-6 relative z-10">
            <div>
              ...
              <p className="text-xs text-sentinel-muted mt-1">AI-driven cross-chain volatility analysis</p>
            </div>
            <div className="flex gap-2">
              {['1H', '24H', '7D'].map((tf) => (
                <button 
                  key={tf}
                  className={`px-3 py-1 rounded text-xs transition-colors font-mono ${tf === '24H' ? 'bg-sentinel-blue/20 text-sentinel-blue border border-sentinel-blue/30' : 'bg-white/5 hover:bg-white/10 text-sentinel-muted'}`}
                >
                  {tf}
                </button>
              ))}
          ...
          <div className="flex flex-col md:flex-row gap-6 flex-1 relative z-10">
            ...
            <div className="flex-1 relative rounded-lg border border-white/5 bg-sentinel-bg/50 backdrop-blur-sm p-1 flex flex-col overflow-hidden group">
              ...
              {/* X-Axis Labels */}
              <div className="h-6 border-t border-white/5 flex justify-between px-2 items-center text-[10px] text-sentinel-muted font-mono relative z-10 bg-sentinel-bg/80">
                <span>00:00</span>
                <span>06:00</span>
                <span>12:00</span>
                <span>18:00</span>
            ...
            <div className="w-full md:w-56 flex flex-col gap-3">
              <div className="bg-white/5 border border-white/5 rounded-lg p-4 flex flex-col gap-1 hover:bg-white/10 transition-colors group">
                 <div className="flex items-center justify-between text-sentinel-muted text-[10px] uppercase font-bold tracking-wider">
      ...
      <div className="fixed bottom-0 left-0 right-0 h-8 bg-sentinel-bg/90 border-t border-white/5 flex items-center overflow-hidden z-40 backdrop-blur">
        ...
        <div className="flex-1 overflow-hidden whitespace-nowrap">
           <motion.div 
             ...
             className="flex gap-12 text-xs font-mono text-sentinel-muted items-center h-full"
           >
